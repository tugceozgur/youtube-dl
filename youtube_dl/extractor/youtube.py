...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    def _real_extract(self, url, website=''):
        ...
        if re.search(r'player-age-gate-content">', video_webpage) is not None:
            ...
            embed_webpage = self._download_webpage_too(url, video_id, 'Downloading embed webpage')
...
class YoutubeChannelIE(YoutubePlaylistBaseInfoExtractor):
    ...
    def _real_extract(self, url, website=''):
        ...
        channel_page = self._download_webpage_too(url, channel_id, 'Downloading page #1')
...
class YoutubeLiveIE(YoutubeBaseInfoExtractor):
    ...
    def _real_extract(self, url, website=''):
        ...
        webpage = self._download_webpage_too(url, channel_id, fatal=False, website=website)
        if webpage:
...
class YoutubeSearchURLIE(YoutubeSearchBaseInfoExtractor):
    ...
    def _real_extract(self, url, website=''):
        ...
        webpage = self._download_webpage_too(url, query, website=website)
